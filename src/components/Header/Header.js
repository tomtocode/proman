                    ...
                    <Row>
                        <Col>
                            <p className="pe-paragraph" style={{ textAlign: "center", color: "white", fontWeight: "bold", fontSize: "medium", verticalAlign: "bottom", paddingBottom: "0px", marginBottom: "0px" }}>
                                Established 2010 | NJ License #16105 | <a style={{ color: "#ef5611" }} href="tel:732-851-4822">(732) 851-4822 </a> | <a style={{ color: "#ef5611" }} href="mailto:promanelectric@gmail.com">promanelectric@gmail.com</a>
                            </p>
                        </Col>
                    </Row>
                </Container>
