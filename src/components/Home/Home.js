    ...
    <>
      ...
      <Container>
        <Row>
          ...
          <h2 className="pe-h1" style={{ textAlign: "center", color: "dimgrey" }}>
            New Jersey's Best Choice For Commercial, Residential and Industrial Electric Services
          </h2>
          <p className="pe-paragraph">
            Fully Licensed and Insured because protecting our customers is a top priority.
            Our founder, Roman, has been in the electical trade for 30+ years and continues to visit
            every job site. Our portfolio consists of large apartment developments, brick and motor businesses,
            industrial
            clients in manufacting and warehousing, as well as local homeowners who are looking
            for reliable work at a reasonable price.
          </p>
        </Row>
        {/* <img src={apartment} width ="40%" alt="Apartment Project" /> */}
